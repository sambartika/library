...
<html lang="en" >
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-faded py-lg-4">
	...
	<?php
		...
		{
			$q = mysqli_query($conn, "UPDATE book set availability=\"".$_POST['availability']."\" where book_id= ".$_POST['count'] ) ;
			$flag=3;
		}
		else{
		}
		if(isSet($_POST['searchname']) && isSet($_POST['searchauthor']) && $_POST['searchname']!= "" && $_POST['searchauthor']!= "")
		{
			...
			$q = mysqli_query($conn, "SELECT * from book where name like \"%".$_POST['searchname']."%\" and author like \"%".$aut."%\" limit 1" ) ;
